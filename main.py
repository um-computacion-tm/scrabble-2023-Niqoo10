...
class Main:
    ...
    def show_rack(self):
        # Devuelve una representación de la mano actual del jugador.
    ...
    def player_play(self):
        # Gestiona las acciones del jugador durante su turno.
    ...
    def player_action(self, action_function):
        # Ejecuta una acción de jugador si está disponible.
    ...
    def show_scores(self):
        # Muestra los puntajes de los jugadores ordenados.
    ...
    def place_word(self):
        while True:
            try:
                ...
                print(f'Error: {e}')
                validate = input('Puedes volver atrás apretando 0 o pulsa cualquier tecla para continuar: ')
                if validate == '0':
                    break
    ...
    def get_word_location_orientation(self):
        while True:
            ...
            location_x = input('Ingrese la fila donde comenzará (0-14): ')
            location_x = self.game.comprobate_is_an_int(location_x)
            location_y = input('Ingrese la columna donde comenzará (0-14): ')
    ...
    def reorganize(self):
        while True:
            ...
            organize = input("Para continuar, puedes presionar cualquier tecla (0 para terminar): ")
    ...
    def convert_wildcard_into_tile(self):
        new_letter = input('¿Por cuál ficha quieres cambiar el comodín? Solo necesitas ingresar
