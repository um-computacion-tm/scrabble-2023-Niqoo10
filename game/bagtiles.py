...
class BagTiles:
    ...
    # Devuelve una lista de `count` fichas aleatorias de la bolsa.
    def take(self, count):
        tiles = []
    ...
    # Coloca una lista de `tiles` en la bolsa.
    ...
    # Devuelve el valor de la letra `letter`.
    def get_value_for_letter(self, letter):
        for tile in self.tiles:
            if tile.letter == letter:
                return tile.value

    # Devuelve una lista de fichas aleatorias para el juego inicial.
